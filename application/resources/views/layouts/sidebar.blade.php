            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="dashboard-4.html">Suppliers</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="dashboard-3.html">Purchases</a>
                        </li>
                        <li>
                            <a href="dashboard-4.html">Stocks</a>
                        </li>
                        <li>
                            <a href="dashboard-4.html">Payment</a>
                        </li>
                        <li>
                            <a href="dashboard-4.html">Payment Method</a>
                        </li>
